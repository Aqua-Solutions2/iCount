        ...
        if ctx.author.id == ctx.guild.owner_id:
            embed = discord.Embed(
                description=f"**__Owner Commands__**\n"
                            ...
                            f"\n• **{prefix}module <module> [on | off]** - Enable or disable modules."
                            f"\n• **{prefix}resetscore <name>** - Reset a user's score."
                            f"\n• **{prefix}automation <create | delete | list>** - Do automated things in your server."
                            ...
                            f"\n• **{prefix}delnotif <id>** - Remove a notification."
